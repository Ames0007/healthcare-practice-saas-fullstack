...
/**
 * Shared setup for every Identity feature test: `RefreshDatabase` (Identity
 * is the first module with real migrations — `users`/`sessions`/
 * `password_reset_tokens`) plus an `Origin` header matching
